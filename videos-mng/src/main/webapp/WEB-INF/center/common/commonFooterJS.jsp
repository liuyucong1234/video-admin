...
<input type="hidden" id="apiServer" name="apiServer" value="http://www.刘宇聪.xyz/videos"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://119.29.2.113/mvc"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://lycdsp.com/lyc-video-mini-api"/> -->
